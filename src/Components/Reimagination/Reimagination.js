        ...
        <div className="container mt-5 border border-dark ">
         <div>
                <div className="row border-dark">
                  <div className="col-md-12 bg-light border border-dark " > <span className="text-uppercase">5. Reimagenation (Ability to Reimagine)</span>- Reimagining Possibilities and 'End' Outcomes </div>
                </div>
                <div className="row">
                ...
                <div className='row text-center'>
                    ...
                    <div className="col border border-dark"></div>
                    <div className="col border border-dark " ></div>
                    <div className="col border border-dark" style={{ backgroundColor:'blue', width:'100px', height:'20px' }}></div>
                </div>
