    ...
    return (
        <section>
            ...
            <div className="container mt-5 border border-dark ">
             <div>
                    <div className="row border-dark">
                      <div className="col-md-12 bg-light border border-dark " > <span className="text-uppercase">1. Relatability (Ability to Relate)</span>- Appreciating where someone is coming from .....  </div>
                    </div>
                    <div className="row">
            ...
            <div className="container border border-dark my-5" style={{ height:'100px'}}>
              ...
              <footer className="mt-5 px-5 text-muted">© {(new Date().getFullYear())} Centre of Strategic Mindset, All Rights Reserved</footer>
        </section>
    );
};
